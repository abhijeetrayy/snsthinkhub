...
export default function card() {
    ...
    return (
        <>
            <div className='w-full ' id="backgroundpatter1">
                ...
                <div className="h-fit  flex justify-center items-center py-20 flex-col">
                    <div className='flex flex-col items-center mb-6 bg-white rounded-lg shadow-md px-8 py-3 bg-cover duration-500 hover:px-10'>
                        <h2 className='text-5xl font-extrabold mb-5 float-left  text-indigo-600'>Course's</h2>
                        <p>Our Courses are Indurties expret fit, which <span className="text-indigo-600">make our student</span> reach their <span className="text-indigo-600">potential and career</span>.</p>
                    </div>

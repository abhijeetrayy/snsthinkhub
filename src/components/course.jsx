...
function course() {
    return (
        <div> <header class="header-section header-shadow">
                                ...
                                <ul class="lab-ul">
                                    ...
                                    <li>
                                        ...
                                        <ul class="lab-ul">
                                            ...
                                            <li>
                                                <a href="course-single.html" class="active"
                                                >Course Details</a
                                                >
                                            </li>
                                        </ul>
            ...
            <div class="pageheader-section style-2">
                <div class="container">
                    <div
                        class="row justify-content-center justify-content-lg-between align-items-center flex-row-reverse"
                    >
                                ...
                                <div class="course-item">
                                    <div class="course-inner">
                                        <div class="course-content">
                                            ...
                                            <p>
                                                In this course take you from the fundamentals and concepts
                                                of data modeling all the way through anumber of best
                                                practices and techniques that you’ll need to build data
                                                models in your organization. You’ll find many By the end
                                                of the course, you’ll be all set to not only put these
                                                principles to works but also to maike the key data
                                            ...
                                            <ul class="lab-ul">
                                                <li>
                                                    <i class="icofont-tick-mark"></i>Ready to begin working
                                                    on real-world data modeling projects
                                                </li>
                                                <li>
                                                    <i class="icofont-tick-mark"></i>Expanded
                                                    responsibilities as part of an existing role
                                                </li>
                                                <li>
                                                    <i class="icofont-tick-mark"></i>Be able to create
                                                    Flyers, Brochures, Advertisements
                                                </li>
                                                <li>
                                                    <i class="icofont-tick-mark"></i>Find a new position
                                                    involving data modeling.
                                                </li>
                                                <li>
                                                    <i class="icofont-tick-mark"></i>Work with color and
                                                    Gradients and Grids
                                                </li>
                                            </ul>
                                            <p>
                                                ...
                                                of data modeling all the way through anumber of best
                                                practices and techniques that you’ll need to build data
                                                models in your organization. You’ll find many examples
                                        ...
                                        <div class="accordion" id="accordionExample">
                                            ...
                                            <div class="accordion-item">
                                                <div class="accordion-header" id="accordion02">
                                                    ...
                                                    >
                                                        <span
                                                        >2.How to Create Mixed Media Art in Adobe
                                                            Photoshop</span
                                                        >
                                                ...
                                                >
                                                    <ul class="lab-ul video-item-list">
                                                        ...
                                                        <li class="d-flex flex-wrap justify-content-between">
                                                            <div class="video-item-title">
                                                                2.4 Digital Painting using photoshop brushes 08:34
                                                                minutes
                                                            </div>
                                                            <div class="video-item-icon">
                                                                <a
                                ...
                                <div class="authors">
                                    ...
                                    <div class="author-content">
                                        ...
                                        <p>
                                            ...
                                            Adobe Photoshop while helping others learn too. Follow me on
                                        ...
                                        <li class="comment">
                                            ...
                                            <div class="com-content">
                                                ...
                                                <p>
                                                    ...
                                                    grass bye the trckli stream and, as I lie close to the
                                                    earth
                                                </p>
                                            </div>
                                            <ul class="comment-list">
                                                <li class="comment">
                                                    ...
                                                    <div class="com-content">
                                                        ...
                                                        <p>
                                                            ...
                                                            entire soul, like these sweet mornings spring which
                                ...
                                <div class="course-side-detail">
                                    <div class="csd-title">
                                        ...
                                        <div class="csdt-right">
                                            <p class="mb-0">
                                                <i class="icofont-clock-time"></i>Limited time offer
                                            </p>
                                        </div>
                                    </div>
                                    <div class="csd-content">
                                        <div class="csdc-lists">
                                            <ul class="lab-ul">
                                                <li>
                                                    <div class="csdc-left">
                                                        <i class="icofont-ui-alarm"></i>Course level
                                                    </div>
                                                    <div class="csdc-right">Beginner</div>
                                                </li>
                                                <li>
                                                    <div class="csdc-left">
                                                        <i class="icofont-book-alt"></i>Course Duration
                                                    </div>
                                                ...
                                                <li>
                                                    <div class="csdc-left">
                                                        <i class="icofont-video-alt"></i>Lessions
                                                    </div>
                                                    <div class="csdc-right">18x</div>
                                                </li>
                                                <li>
                                                    <div class="csdc-left">
                                                        <i class="icofont-abacus-alt"></i>Quizzes
                                                    </div>
                                                    <div class="csdc-right">0</div>
                                                </li>
                                                <li>
                                                    <div class="csdc-left">
                                                        <i class="icofont-hour-glass"></i>Pass parcentages
                                                    </div>
                                                    <div class="csdc-right">80</div>
                                                </li>
                                                <li>
                                                    <div class="csdc-left">
                                                        <i class="icofont-certificate"></i>Certificate
                                                    </div>

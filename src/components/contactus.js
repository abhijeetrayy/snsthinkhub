                    ...
                    <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
                        <div class="mb-12 max-w-[570px] lg:mb-0">
                            ...
                            <p class="text-body-color mb-9 text-base leading-relaxed">
                                SnSThinkhub is a company that was established in 2019 with the
                                mission of filling the gap between industry and training given
                                to students at the graduate and postgraduate level.
                            </p>

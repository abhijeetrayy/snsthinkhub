      ...
      <div className="flex flex-col items-center px-8 py-20 lg:flex lg:justify-between sm:flex-row">
        ...
        <div className="flex flex-col gap-4 items-center sm:flex-row mt-3 md:mt-0">
          <input
            ...
            className="z-20 p-2 h-12 ring-2 ring-indigo-700 focus:ring-3 w-48 rounded-lg mx-3  sm:w-56 md:w-64  inline-block"
            placeholder="abc@gmail.com"
          />
          <button
            onClick={() => handleSubmit()}
            className="z-20 block px-8 py-2  text-lg font-medium text-center text-white bg-indigo-800 rounded "
            href="#"
          >

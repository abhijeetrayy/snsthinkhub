...
export default function contactus() {
  ...
  return (
    <section class="w-full flex flex-col justify-center z-10 overflow-hidden bg-white p-5 pt-10 ">
          ...
          <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div class="mb-12 max-w-[570px] lg:mb-0">
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  <h4 class="text-dark mb-1 text-lg font-semibold">
                    Our Location
                  </h4>
              ...
              <div class="mb-8 flex w-full max-w-[370px]">
                ...
                <div class="w-full">
                  ...
                  <p class="text-body-color text-base">info.snsthinkhub.com</p>
                </div>
              </div>
            </div>
          </div>
              ...
              <form>
                ...
                <div>
                  <button
                    ...
                    class="bg-indigo-500 border-primary w-full rounded border p-3 text-white transition hover:bg-opacity-90"
                  >
                    {loading ? (

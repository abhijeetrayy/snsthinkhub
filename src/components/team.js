                ...
                <div>
                    <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                        <img
                            ...
                            alt="Person"
                        />
                        <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-indigo-500 bg-opacity-75 opacity-0 hover:opacity-100">
                            <p className="mb-1 text-lg font-bold text-gray-50">
                                Oliver Aguilerra
                            </p>
                            <p className="mb-4 text-xs text-gray-50">Product Manager</p>
                ...
                <div>
                    <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-indigo-500 bg-opacity-75 opacity-0 hover:opacity-100">
                            ...
                            <p className="mb-4 text-xs text-gray-50">Design Team Lead</p>
                            <p className="mb-4 text-xs tracking-wide text-white">
                ...
                <div>
                    <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-indigo-500 bg-opacity-75 opacity-0 hover:opacity-100">
                            ...
                            <p className="mb-4 text-xs text-gray-50">CTO, Lorem Inc.</p>
                            <p className="mb-4 text-xs tracking-wide text-white">
                ...
                <div>
                    <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-indigo-500 bg-opacity-75 opacity-0 hover:opacity-100">
                            ...
                            <p className="mb-4 text-xs text-gray-50">Human Resources</p>
                            <p className="mb-4 text-xs tracking-wide text-white">
                ...
                <div>
                    <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-indigo-500 bg-opacity-75 opacity-0 hover:opacity-100">
                            ...
                            <p className="mb-4 text-xs text-gray-50">Good guy</p>
                            <p className="mb-4 text-xs tracking-wide text-white">
                ...
                <div>
                    <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-indigo-500 bg-opacity-75 opacity-0 hover:opacity-100">
                            ...
                            <p className="mb-4 text-xs text-gray-50">Backend Developer</p>
                            <p className="mb-4 text-xs tracking-wide text-white">
                ...
                <div>
                    <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-indigo-500 bg-opacity-75 opacity-0 hover:opacity-100">
                            ...
                            <p className="mb-4 text-xs text-gray-50">Designer</p>
                            <p className="mb-4 text-xs tracking-wide text-white">
                ...
                <div>
                    <div className="relative overflow-hidden transition duration-300 transform rounded shadow-lg lg:hover:-translate-y-2 hover:shadow-2xl">
                        ...
                        <div className="absolute inset-0 flex flex-col justify-center px-5 py-4 text-center transition-opacity duration-300 bg-indigo-500 bg-opacity-75 opacity-0 hover:opacity-100">
                            ...
                            <p className="mb-4 text-xs text-gray-50">Frontend Developer</p>
                            <p className="mb-4 text-xs tracking-wide text-white">

...
export default function Example() {
    ...
    const handleContentTitle = (event) => {
        ...
        setContent((previewData) => ({ ...previewData, title: { ...previewData.title, [name]: value, } }
        ));
    };
    const handleContentDetail = (event) => {
        ...
        setContent((previewData) => ({ ...previewData, detail: { ...previewData.detail, [name]: value, } }
        ));
    };
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            <button type="button" onClick={programF}>Click</button>
        </form>
    );
}

        ...
        <section className=" container mx-auto bg-gray-800">
            <div className="flex flex-col items-center px-8 py-20 lg:flex lg:justify-between sm:flex-row">
                ...
                <div className='flex flex-col gap-4 items-center sm:flex-row '>
                    ...
                    <input className='z-50 p-2 h-12 ring-2 ring-indigo-700 focus:ring-3 w-48 rounded-lg mx-3  sm:w-56 md:w-64 sm:mt-4 inline-block' type="email" placeholder='abc@gmail.com' />
                    <button

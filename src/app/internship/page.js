        ...
        <div className="w-full flex justify-between items-center sm:w-[740px] lg:w-[1124px] p-6 m-3 shadow-md border-2 rounded-lg">
          ...
          <div className="ml-3 flex flex-col sm:flex-row gap-3 ">
            <button
              ...
              className="z-20 px-3 py-2 rounded-md bg-indigo-50 text-indigo-400 mr-3 sm:text-sm hover:bg-indigo-200 hover:border-0 transition  text-xs"
            >
              All
            </button>
            <button
              onClick={() => filterData("Remote")}
              className="z-20 px-3 py-2 rounded-md bg-indigo-50 text-indigo-400 mr-3 sm:text-sm  hover:bg-indigo-200 hover:border-0 transition  text-xs"
            >
              Remote
            </button>
            <button
              onClick={() => filterData("Inoffice")}
              className="z-20 px-3 py-2 rounded-md bg-indigo-50 text-indigo-400 sm:text-sm hover:bg-indigo-200 hover:border-0 transition  text-xs"
            >
              Offline/In Office
            </button>
          </div>

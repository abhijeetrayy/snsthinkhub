...
<svg width="100%" height="100%" id="svg" viewBox="0 0 1440 690" xmlns="http://www.w3.org/2000/svg" class="transition duration-300 ease-in-out delay-150"><path d="M 0,700 C 0,700 0,175 0,175 C 62.77743004418264,155.80228276877762 125.55486008836527,136.60456553755523 181,133 C 236.44513991163473,129.39543446244477 284.55798969072157,141.3840206185567 343,149 C 401.44201030927843,156.6159793814433 470.21318114874816,159.85935198821798 535,171 C 599.7868188512518,182.14064801178202 660.5892857142857,201.17857142857142 720,189 C 779.4107142857143,176.82142857142858 837.429675994109,133.42636229749633 899,133 C 960.570324005891,132.57363770250367 1025.6920103092784,175.1159793814433 1088,198 C 1150.3079896907216,220.8840206185567 1209.8022827687778,224.10972017673046 1268,217 C 1326.1977172312222,209.89027982326954 1383.098858615611,192.44513991163478 1440,175 C 1440,175 1440,700 1440,700 Z" stroke="none" stroke-width="0" fill="#4f46e5" fill-opacity="0.4" class="transition-all duration-300 ease-in-out delay-150 path-0" transform="rotate(-180 720 350)"></path><path d="M 0,700 C 0,700 0,350 0,350 C 59.96575846833579,353.659793814433 119.93151693667158,357.319587628866 183,358 C 246.06848306332842,358.680412371134 312.2396907216495,356.3814432989691 372,367 C 431.7603092783505,377.6185567010309 485.10972017673055,401.1546391752577 538,387 C 590.8902798232695,372.8453608247423 643.3214285714284,321 705,302 C 766.6785714285716,283 837.6045655375553,296.8453608247423 900,332 C 962.3954344624447,367.1546391752577 1016.2603092783504,423.6185567010309 1067,413 C 1117.7396907216496,402.3814432989691 1165.3541973490428,324.680412371134 1227,303 C 1288.6458026509572,281.319587628866 1364.3229013254786,315.659793814433 1440,350 C 1440,350 1440,700 1440,700 Z" stroke="none" stroke-width="0" fill="#4f46e5" fill-opacity="0.53" class="transition-all duration-300 ease-in-out delay-150 path-1" transform="rotate(-180 720 350)"></path><path d="M 0,700 C 0,700 0,525 0,525 C 42.117820324005876,532.634204712813 84.23564064801175,540.2684094256259 147,540 C 209.76435935198825,539.7315905743741 293.1752577319588,531.5605670103092 367,528 C 440.8247422680412,524.4394329896908 505.06332842415304,525.4893225331369 555,508 C 604.936671575847,490.51067746686306 640.5714285714288,454.48214285714283 703,464 C 765.4285714285712,473.51785714285717 854.6509572901325,528.5821060382916 921,525 C 987.3490427098675,521.4178939617084 1030.8247422680413,459.18943298969066 1083,466 C 1135.1752577319587,472.81056701030934 1196.0500736377026,548.6601620029455 1257,570 C 1317.9499263622974,591.3398379970545 1378.9749631811487,558.1699189985272 1440,525 C 1440,525 1440,700 1440,700 Z" stroke="none" stroke-width="0" fill="#4f46e5" fill-opacity="1" class="transition-all duration-300 ease-in-out delay-150 path-2" transform="rotate(-180 720 350)"></path></svg>          
  </div>
		<div className="z-50 w-full flex flex-col items-center">
		
			<div className="z-50 max-w-5xl flex flex-col items-center p-3 mt-16">

				<div className=" w-full p-3 bg-white sm:bg-opacity-0 sm:p-6 flex items-center justify-center rounded-md m-4 sm:text-white shadow-lg"><span className=" text-3xl sm:text-5xl font-bold">Our talented team of professionals 😎</span></div>
				<div className="grid  grid-cols-1 gap-4">
				{data.map((item,index)=>(
						<div key={index} className="bg-white group w-full  sm:w-[600px] grid grid-cols-1 sm:grid-cols-6 border-2 border-indigo-50  shadow-lg p-3 rounded-md gap-4">
							<div className="col-span-1  sm:col-span-2 ">
								<Image className=" w-40 h-40 object-cover rounded-md" width={100} height={100} src={item.Image}/>
							</div>
							<div className="transition ease-in-out delay-200 group-hover:translate-x-5 duration-300 col-span-1 sm:col-span-4  sm:border-2 sm:border-l-indigo-800 sm:border-transparent pl-3 flex flex-col gap-2">
					            ...
					            <div>
					             <span className="text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
